...
//		tool.DrawLine(250, maxHeight, 1975, 1);
	...
	private int Draw_ContentsHeader(TemplateTool tool) {
		...
		try 
		{
			...
			tool.DrawText("��û�μ�\n(��ǰó)" , 1255, 949, 1508, 1059, tool.CENTER);
			...
			tool.DrawText("��ǰ���\n(��ü)" , 389, 1060, 624, 1159, tool.CENTER);
			...
			tool.DrawText("�Ƿ���\n����ó" , 1758, 1060, 2011, 1159, tool.CENTER);
			tool.DrawText("������\n����ó" , 2011, 1060, 2224, 1159, tool.CENTER);
		}
		catch(Exception e)
		{
	...
	private boolean Draw_Header(TemplateTool tool) {
		...
		{	
			...
			tool.DrawText("�ŷ�ó�ڵ� : " + vdcd + "(" + vd_nm_loc + ", " + erp_vdcd +")" , 250, 780, 2230, 800, tool.LEFT);
			
			String pono 		= obj_orderInfo.get("PO_NO").getAsString();
			tool.DrawText("���� NO : " + pono, 250, 830, 2230, 850, tool.LEFT);
			
			tool.setFontStyle("Dotum", tool.NORMAL, 34);
			tool.DrawText("1. ���ֳ���", 250, 880, 2230, 910, tool.LEFT);
